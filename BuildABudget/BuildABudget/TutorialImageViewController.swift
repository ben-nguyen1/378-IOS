...
class TutorialImageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (fileName == "1") {
            ...
            label.text = "In the goals screen, you can add financial goals that you want to work towards. Examples of goals can be a vacation or a new car. A progress bar is shown under each goal as well as a percentage to indicate completion"
        } else if (fileName == "6") {
